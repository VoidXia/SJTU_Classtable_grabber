...
print("You can also integrate your own jAccount password into this program.\n")
print("If you need to use it in other semesters, please revise it yourself.  \nOr perhaps we will.\n")
print("Although we have already downloaded it for you, you may download the chrome driver from https://sites.google.com/a/chromium.org/chromedriver/home if a problem occured.\n")
